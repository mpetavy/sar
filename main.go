...
func main() {
	...
	common.New(&common.App{"sar", "1.0.7", "2018", "Simple search and replace", "mpetavy", common.APACHE, "https://github.com/mpetavy/sar", false, prepare, nil, nil, run, time.Duration(0)}, []string{"s"})
	common.Run()
}
